...
# Project files
from internvl.train.mbeir_utils import (
    format_string,
    hash_did,
    hash_qid,
    get_mbeir_task_id,
...
class MBEIRMainDataset(MBEIRDatasetBase):
    def __init__(
        ...
        self.return_img_as_path = return_img_as_path
    ...
    def __getitem__(self, index):
        ...
        def _prepare_data_dict(txt, img_path):
            img = self._load_and_preprocess_image(img_path) if not self.return_img_as_path else img_path
...
class MbeirAdapter():
    def __init__(self,
        ...
        mbeir_args = (
            ...
            data_args.mbeir_train_root,
            data_args.mbeir_cand_root,
            data_args.mbeir_instruction_root,
            None
        )

        self.base_ds = MBEIRMainDataset(*mbeir_args, return_img_as_path=True, print_config=False)
