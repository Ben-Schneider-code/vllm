...
from llava.llava_dataset import build_contrastive_dataset, build_eval_datasets, LLavaCollate
...
def main():
    ...
    model, processor = load_model(model_args, data_args, training_args)
    ...
    trainer = ContrastiveTrainer(
        ...
        tokenizer=processor,
        data_collator=LLavaCollate(processor)
    )
